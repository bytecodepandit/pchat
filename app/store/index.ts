...
import {
  chatsReducer as chatList,
  chatSelectionReducer as selectedChats,
} from './reducers/tabs/chats.reducer';
import {
  UsersWithSectionReducer as userWithSection,
  UsersForGroupCreationReducer as userForGroupCreation,
} from './reducers/users-with-section.reducer';
...
import {
  setUsersCallHistoryReducer as callHistory,
  setCallingTypeReducer as callingType,
} from './reducers/tabs/call-history.reducer';
