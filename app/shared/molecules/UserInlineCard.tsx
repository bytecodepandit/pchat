      ...
      <View style={{ flex: 1 }}>
        <ListItem
          ...
          {!props.avatarComponent ? (
            <AvatarAtom title={props.name[0]} {...props.avatar} />
          ) : (
            props.avatarComponent
          )}
          <ListItem.Content
            style={[styles.listItemContentStyle, props.listItemContentStyle]}>
            <View
              style={[styles.listItemHeaderStyle, props.listItemHeaderStyle]}>
              <ListItem.Title
