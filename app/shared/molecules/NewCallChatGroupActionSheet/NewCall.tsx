...
import { GestureResponderEvent, NativeScrollEvent, NativeSyntheticEvent, TouchableOpacity, View, TouchableWithoutFeedback } from 'react-native';
// @ts-ignore
...
const NewCall = ({
    close, onScroll, onNewGroup, onNormalCall, onVideoCall
}: NewCallProps) => {
    ...
    const _renderHeader = () => {
        ...
        >
            ...
            <View style={{ flex: 1, justifyContent: 'center' }}>
                <Text variant="headingM" textAlign="center">{i18n.t('new')} {i18n.t('calls')}</Text>
            </View>
        ...
        <View >
            <UserInlineCard
                ...
                rightChidren={
                    ...
                    >
                        <TouchableWithoutFeedback onPress={onNormalCall}><Ionicons name="call-outline" color={colors.darkBlue} size={RFValue(18)} /></TouchableWithoutFeedback>
                        <TouchableWithoutFeedback onPress={onVideoCall} ><Ionicons name="videocam-outline" color={colors.darkBlue} size={RFValue(20)} style={{ marginLeft: scale(10) }} /></TouchableWithoutFeedback>
                    </Box>}
            />
        </View>
    );
