...
const StatusScrollableHeader = ({ opacity, headingScale, addStatus }: StatusScrollableHeaderProps) => {
    return (
        <Box backgroundColor="white">
            ...
            <ListItem style={{ borderTopWidth: verticalScale(1), borderTopColor: colors.divider }}>
                <Avatar
                    rounded
                ...
                <ListItem.Content style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Box>
                        <ListItem.Title style={{ color: colors.secondary, fontWeight: '500' }}>My Status</ListItem.Title>
                        <ListItem.Subtitle style={{ color: colors.primary }}>Add to my status</ListItem.Subtitle>
                    </Box>
                    <Box
                        flexDirection="row"
                    >
                        <TouchableWithoutFeedback onPress={addStatus}>
                            <CircleAtom >
                                <Ionicons name="camera" color={colors.darkBlue} size={RFValue(16)} />
                            </CircleAtom>
                        </TouchableWithoutFeedback>
                        <TouchableWithoutFeedback >
                            <CircleAtom style={{ marginLeft: scale(5) }}>
                                <MaterialIcons name="edit" color={colors.darkBlue} size={RFValue(16)} />
                            </CircleAtom>
                        </TouchableWithoutFeedback>
                    </Box>
                </ListItem.Content>
            </ListItem>
            <Box paddingHorizontal="hm" backgroundColor="offWhite" paddingTop="hl"
                style={{
                ...
                <Text textTransform="uppercase" color="primary">{i18n.t('recent')} {i18n.t('updates')}</Text>
            </Box>
        </Box>
    )
}
