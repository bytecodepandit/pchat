...
import {
  ...
  SETTINGS_SCREEN,
  STATUS_SCREEN,
} from '@app/routes/app-route-labels';
...
const AppTabIcons = (
  ...
  switch (tabName) {
    ...
    case CHATS_NAVIGATOR:
      return tabIcon(
        focused ? 'md-chatbubbles-sharp' : 'md-chatbubbles-outline',
      );
...
export const AppTab = () => {
  ...
  return (
    <Tab.Navigator
        ...
        style: tabBarVisible
          ? {
              ...
              paddingBottom: verticalScale(
                !Device.isTablet ? (Device.isIphoneX ? 15 : 5) : 5,
              ),
              paddingTop: verticalScale(
                !Device.isTablet ? (Device.isIphoneX ? 5 : 5) : 5,
              ),
              height: verticalScale(
                !Device.isTablet ? (Device.isIphoneX ? 55 : 50) : 40,
              ),
            }
          : null,
      }}>
      ...
      />
      <Tab.Screen
        name={CALL_HISTORY_SCREEN}
        component={CallHistoryScreen}
        options={{ title: i18n.t('calls') }}
      />
      <Tab.Screen
        name={CAMERA_SCREEN}
