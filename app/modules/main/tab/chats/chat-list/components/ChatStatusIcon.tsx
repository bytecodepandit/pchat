    ...
    const _renderChatStatusIcon = () => {
        switch (chatStatus) {
            case ChatStatus.PENDING:
                return <EvilIcons name="clock" size={RFValue(17)} color={colors.primary} />
            case ChatStatus.DELIVERED:
                return <IonIcons name="checkmark" size={RFValue(17)} color={colors.primary} />
            case ChatStatus.REACHED:
                return <IonIcons name="checkmark-done" size={RFValue(17)} color={colors.primary} />
            case ChatStatus.VIEWED:
                return <IonIcons name="checkmark-done" color={colors.skyblue} size={RFValue(16)} />
            default:
                return null
