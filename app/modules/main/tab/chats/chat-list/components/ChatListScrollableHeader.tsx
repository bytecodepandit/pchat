    ...
    <Box>
      ...
      <Animated.View
        ...
        <Box flexDirection="row" alignItems="center">
          ...
          <Text paddingLeft="s" color="darkBlue" fontSize={RFValue(16)}>
            {i18n.t('archived')}
          </Text>
        </Box>
        <Text color="primary" fontSize={RFValue(16)}>
          1
        </Text>
      </Animated.View>
      <Box
        ...
        <TouchableOpacity onPress={() => {}}>
          <Text color="darkBlue" fontSize={RFValue(16)}>
            {i18n.t('broadcastList')}
          </Text>
        </TouchableOpacity>
