...
export class RestApiService {
    public invoke<T>(def: APIDef, apiInput: APIInput = {}, data?: T, queryMap?: any, additionalHeaders?: any, handleError?: boolean) {
        return this.invokeAPI(def.api(apiInput), def.method, data, queryMap, additionalHeaders, handleError);
    }

    private invokeAPI<T>(api: string, method: string, body?: T, queryMap?: any, additionalHeaders = {}, handleError = true) {
        const headers = {
